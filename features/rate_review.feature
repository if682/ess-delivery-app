Feature: Avaliar reviews (rate reviews)
	...
	Cenário: curtir review (cenário bem-sucedido)
		...
		And E o número de curtidas da review passa a ser 26.

	Cenário: descurtir de review
		Given Dado que estou na página do filme “Psicose”,
		And E eu estou logado em minha conta,
		And E eu vejo uma review com o título “Melhor filme de terror de todos os tempos”,
		...
		And E o número de curtidas da review passa a ser 24.

	Cenário: curtir review sem estar logado (cenário malsucedido)
		Given Dado que estou na página do filme “Psicose”,
