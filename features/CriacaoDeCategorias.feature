Feature: Criação de categorias de itens
    ...
    Scenario: Acessar uma categoria de itens sem item
        ...
        And eu vejo a lista com todas as páginas de itens da categoria "Fast-food"
        When eu clico no item "Hamburguer"
        Then eu devo ser redirecionado para a página "Hamburguer"
