...
When eu digito na barra de pesquisa por localidade "Jericoacoara"
...
Given estou na página "Home"
And existem os anúncios "Chalet - Barra Grande" e "Cabana - Jericoacoara"
When eu digito na barra de pesquisa por localidade "Manaus"
And pressiono o botão para pesquisar
...
Cenário 4 - Filtro por número de pessoas
Given estou na página "Home"
And existem os anúncios "Chalet - Barra Grande" e "Cabana - Jericoacoara"
